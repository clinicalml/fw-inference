...
#ifdef BOOST
	cerr << "   -mst : maximum spanning tree DAC ordering";
...
//				if (ToulBar2::varOrder) delete [] ToulBar2::varOrder;
	...
	if (ToulBar2::uai || ToulBar2::uaieval) {
	  ...
	  //MODIFIED
	  string filename(tmpFile); 		//Previously: string filename(tmpPath);
	  //filename += "/";  			   //Commented this
	  //filename += basename(tmpFile); //Commented this
	  //END MODIFIED
	  ...
	  //MODIFIED
      cout<<"DEBUG MODIFIED: Now using filename: "<<endl;
      cout << filename <<endl;
	  //END MODIFIED
